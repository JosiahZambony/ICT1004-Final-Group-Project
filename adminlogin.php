    ...
    <body>
        ...
        <section class="row-md">
            <div class="container p-3">
                ...
                <p class="lead">This login is only for admins! If you are not an admin, you may register here instead:
                    <a href="register.php">Register page</a>
                </p>
            </div>
        </section>
        <section class="row-md">
            <form class="container p-3" action="admin_login_process.php" method="post">
